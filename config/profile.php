...
return [
    ...
    'projects' => [
        [
            ...
            'desc'       => 'A full-featured web application designed to simplify business administration for small and medium-sized enterprises. SME Managers provides a centralised portal for user management, account control, and core business operations — helping SME owners run their businesses more efficiently.',
            'highlights' => [
                ...
                'Designed for small and medium-sized enterprises across Kenya',
            ],
            'tags'       => ['Web App', 'Business Management', 'Full-Stack', 'SME'],
            'featured'   => true,
        ],
    ],
